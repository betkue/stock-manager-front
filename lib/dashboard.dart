                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  productInfo("count of all product",
                                      dashboard['count_of_all_product'], true),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  Divider(),
                                  productInfo("Product out of stock",
                                      dashboard['product_out_of_stock'], true),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  Divider(),
                                  productInfo("Product overstocked",
                                      dashboard['product_overstocked'], true),
                                ],
                              ),
                            ),
                          ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      productInfo("Quantity in hand",
                                          dashboard['quantity_in_hand'], false),
                                      SizedBox(
                                        height: 15,
                                      ),
                                      productInfo(
                                          "Quantity to be received",
                                          dashboard['quantity_to_be_received'],
                                          false),
                                      SizedBox(
                                        height: 15,
                                      ),
                                      productInfo(
                                          ...
                                          dashboard['quantity_to_be_delivered'],
                                          false),
                                    ],
                                  ),
                                ],
