...
//pick image from camera
  ...
  getData() async {
    ...
    if (result == true) {
      ...
      sigleController.text = supplier_single['sigle'] ?? "";
      currency_id = supplier_single['currency_id'];
      country_id = supplier_single['country_id'];
    ...
    return load
        ...
        : Scaffold(
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            var result = await deleteSupplier();
            ...
            body: SafeArea(
              child: Stack(
                children: [
                  widget.id != null && supplier_single.isEmpty
                      ? NoData(onTap: () async {
                          await getData();
                        })
                      : Padding(
