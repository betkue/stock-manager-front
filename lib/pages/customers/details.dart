...
//pick image from camera
  ...
  getData() async {
    ...
    if (result == true) {
      ...
      sigleController.text = customer_single['sigle'] ?? "";
      currency_id = customer_single['currency_id'];
      country_id = customer_single['country_id'];

      for (var element in countries) {
        if (element['id'] == country_id) {
          countryController.text = element['name'] ?? "";
        }
      }
      // locations = ['locations'];
    }
    ...
    return load
        ...
        : Scaffold(
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            var result = await deleteCustomer();
            ...
            body: SafeArea(
              child: Stack(
                children: [
                  widget.id != null && customer_single.isEmpty
                      ? NoData(onTap: () async {
                          await getData();
                        })
                      : Padding(
